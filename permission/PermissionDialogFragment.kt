...
/**
 * Created by Egemen Hamutçu on 2020-01-03.
 *
 * # A Primary Class For Permission Works
 * ## Usage:
 * Implement this dialog fragment if your dialog fragment requires Android permission. You have to
 *
 * only call [checkPermissionsAreGranted] method with a desired [BusinessRequest] and process your
 *
 * work in [onPermissionsGranted] method in case of user grant for permissions.
 * ##
 * ## **NEVER** throw a dialog to the user in your dialog fragment!
 *
 * If user denies any permissions, this dialog fragment will throw a necessary dialog for you, so
 *
 * you must **NOT** try to throw a dialog to the user. This dialog fragment will take necessary
 *
 * actions according to user choices. You can optionally override [onPermissionsDenied] method if
 *
 * you need to do extra work in case of user denial for permissions.
 * ##
...
abstract class PermissionDialogFragment : DialogFragment() {
     ...
     *
     * @param exitOnDenied An optional parameter. It will make your dialog fragment dismiss when
     *
     * user denies permissions. Pass it **true** if your dialog fragment cannot live without
     *
     * permissions. **PLEASE** be careful and do **NOT** mix your dialog fragment with its activity.
     *
     * You may want to finish also the activity of your dialog fragment. In that case, pass it
     *
     * **true** and override [onPermissionsDenied] method and finish your activity in it.
     *
     * Default is **false**
     *
     * @author Egemen Hamutçu
    ...
    /**
     * # ATTENTION!
     * ## Never override this method to show an [AlertDialog]. [PermissionDialogFragment] handles it for you!
     *
