...
import com.ehamutcu.gloriouspermissions.R
import com.ehamutcu.gloriouspermissions.util.StringUtil
 ...
 *
 * This class manages all business logic of permission process and is a loyal disciple for Android's
 *
 * native behavior of permissions.
 *
 * It works as a field in [PermissionActivity], [PermissionFragment] and [PermissionDialogFragment],
 *
 * and cannot be seen by any classes who implement the classes above. It secretly handles all
 *
 * difficulties of permission process in one place and make users happy with their choices. If one
 *
